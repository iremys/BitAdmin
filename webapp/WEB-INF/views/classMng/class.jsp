								...
								<div class="sub-box fileDiv" style="display: none;">
											...
											<tbody>
												<tr>
													...
													<td colspan="3" class="form-inline">
														...
														<input type="text" class="form-control" name="curri_id" value="-1">
												...
												<tr>
													<th>교육과정명</th>
													<td colspan="3">
														<span class="text_middle" id="text_className"></span>
													</td>
													<th>운영코드</th>
													<td>
												...
												<tr>
													...
													<td>
														<div class="input-group border-inputcolor w180">
  																<input type="text" class="input-sm form-control border-none classAuto" name="startDate" value="" id="startDate" data-select="datepicker" data-toggle="datepicker" placeholder="YYYY-MM-DD">
													...
													<td >		
														<div class="input-group border-inputcolor w180">
  																<input type="text" class="input-sm form-control border-none classAuto" name="endDate" value="" id="endDate" data-select="datepicker" data-toggle="datepicker" placeholder="YYYY-MM-DD">
  																<span class="input-group-btn"><button type="button" class="btn btn-date border-none" data-toggle="datepicker"><i class="fa fa-calendar"></i></button></span>
														</div>
													</td>												
												...
												<tr id="tr_testDate">
													...
													<td colspan="5" id="testTimeTd">
														<div class='pull-left form-inline w240 testTimeArea'>
															<span class='input-group border-inputcolor w120'>
																<input type='text' name='testDate' value="" class='form-control border-none'  data-select='datepicker' data-toggle='datepicker'  placeholder='YYYY-MM-DD'>
															...
															<span>
																<select class='form-control w80' name='testTime' >
									...
									<div class="sub-toolbox clearfix text-center">
										<div class="row" >
											...
											<div class="col-xs-4">
												<input type="button" id="btn_class_modify" value="수정" class="btn btn-primary">
											</div>
											<div class="col-xs-4">
											</div>
										</div>
									...
									<div class="sub-body">
										...
										<div class="nav-tabs-custom">
											...
											<ul class="nav nav-tabs" id="classTab">
												<li class=""><a href="#tab_applicantMng" data-toggle="tab">지원자관리</a></li>
												<li class="active"><a href="#tab_2" data-toggle="tab">강사/강의실 배치(이후추가)</a></li>
											</ul>
											<!-- /.상단탭영역 -->
									
											<!-- 탭내용박스 -->
											<div class="tab-content" id="table_class">
												
												<!--탭01 커리큘럼기본정보  -->
												<c:import url="/WEB-INF/views/classMng/classTab01.jsp"></c:import>
...
<c:import url="/WEB-INF/views/classMng/classTab01_js.jsp"></c:import>
</body>
