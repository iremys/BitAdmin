									...
									<div class="sub-box fileDiv" style="display: none; ">
										...
										<div class="sub-body">
											...
											<div class="nav-tabs-custom">
												...
												<!-- 상단탭영역 -->
												<ul class="nav nav-tabs" id="curriTab">
...
<!-- 해당페이지용 자바스트립트-->
<c:import url="/WEB-INF/views/courseDesign/curri_js.jsp"></c:import>
<c:import url="/WEB-INF/views/courseDesign/curriTab01_js.jsp"></c:import>
<c:import url="/WEB-INF/views/courseDesign/curriTab02_js.jsp"></c:import>
<c:import url="/WEB-INF/views/courseDesign/curriModal_js.jsp"></c:import>	
