					...
					<div class="box box-body">
						<div class="row">
							...
							<div class="col-xs-3">
								...
								<div class="sub-box">
									...
									<div class="sub-toolbox">
										<div class="row">
											<div class="col-xs-12">
												<div class="sub-title">메뉴카테고리</div>
											</div>
										</div><!-- /.row -->
									</div>
									<!-- /.sub-toolbox -->
							...
							<div class="col-xs-9">
								...
								<!-- 카테고리 선택했을때-->
								<div class="sub-box cateDiv" style="display: none; ">
								...
								<div class="sub-box fileDiv" style="display: none; ">
									...
									<div class="sub-toolbox">
										<div class="row">
											<div class="col-xs-6">
												<span class="sub-title">코드편집</span>
											</div>
											<div class="col-xs-6">
											...
											<table class="table table-condensed no-border">
												...
												<tbody id=''>
													<tr>
														<!-- <th>내용</th> -->
														<td>
															<textarea id="hIncludeHtml" class="form-control"  name="hIncludeHtml" >
${hContentVo.contentHtml}
															</textarea>		
														</td>
													</tr>
												</tbody>
										...
										<div class="sub-toolbox clearfix text-center">
											<div class="row" >
												...
												<div class="col-xs-4">
													<input type="button" id="btn_hInclude_modify" value="수정" class="btn btn-primary">
												</div>
												<div class="col-xs-4">
										...
										<!-- /.sub-toolbox -->
										<input class="form-control" type="text" name="hInclude_id" value="">
									</form>
...
<c:import url="/WEB-INF/views/hPageMng/hInclude_js.jsp"></c:import>
</body>
